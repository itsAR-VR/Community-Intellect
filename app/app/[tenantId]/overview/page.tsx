...
import { mockMembers, mockOpportunities, mockForcedSuccessItems, mockDrafts, mockNotifications } from "@/lib/mock-data"
...
export default function OverviewPage() {
  ...
  const forcedSuccessDue = mockForcedSuccessItems.filter((f) => !f.deliveredAt && !f.blocked)
  const escalations = mockNotifications.filter((n) => n.type === "escalation" && !n.read)

  const priorityActions = mockOpportunities
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href={`/app/${tenantId}/opportunities`}>
                View All
          ...
          <CardContent>
            <div className="space-y-4">
              {priorityActions.map((action) => {
                const member = mockMembers.find((m) => m.id === action.memberId)
                return (
                  <div
                    key={action.id}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 sm:ml-auto pl-13 sm:pl-0">
                      ...
                      <Button size="sm" variant="outline" asChild className="shrink-0 bg-transparent">
                        <Link href={`/app/${tenantId}/drafts`}>Draft</Link>
                      </Button>
                    </div>
                  </div>
                )
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href={`/app/${tenantId}/attention`}>View All</Link>
            </Button>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
