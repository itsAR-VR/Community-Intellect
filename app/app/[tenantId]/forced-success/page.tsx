...
import { mockMembers, mockForcedSuccessItems } from "@/lib/mock-data"
import type { TenantId } from "@/lib/types"
import { format, startOfWeek, addWeeks, subWeeks } from "date-fns"

export default function ForcedSuccessPage() {
  ...
  const items = mockForcedSuccessItems.filter((item) => {
    const member = mockMembers.find((m) => m.id === item.memberId)
