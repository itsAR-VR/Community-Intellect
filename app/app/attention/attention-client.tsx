...
import type { Member, ExternalSignal } from "@/lib/types"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <Link href={`/app/members/${item.member.id}`} className="font-semibold hover:underline">
                ...
                <div className="text-right space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Button size="sm" variant="outline" asChild>
                      <Link href={`/app/members/${item.member.id}`}>Profile</Link>
                    </Button>
                    <Button size="sm">
