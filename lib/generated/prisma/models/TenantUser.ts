...
export type TenantUserCreateInput = {
  ...
  user: Prisma.ProfileCreateNestedOneWithoutTenantUsersInput
}
...
export type TenantUserUpdateInput = {
  ...
  user?: Prisma.ProfileUpdateOneRequiredWithoutTenantUsersNestedInput
}
...
export type TenantUserOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tenantId" | "userId" | "createdAt", ExtArgs["result"]["tenantUser"]>
...
export interface TenantUserDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const tenantUserWithTenantIdOnly = await prisma.tenantUser.findMany({ select: { tenantId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many TenantUsers and only return the `tenantId`
   * const tenantUserWithTenantIdOnly = await prisma.tenantUser.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more TenantUsers and only return the `tenantId`
   * const tenantUserWithTenantIdOnly = await prisma.tenantUser.updateManyAndReturn({
   *   select: { tenantId: true },
   *   where: {
   *     // ... provide filter here
   *   },
